        ...
        <div class="container-xxl mx-auto p-0  position-relative header-2-2" style="font-family: 'Poppins', sans-serif">
            <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content bg-white border-0">
                            ...
                            <div class="modal-footer border-0 gap-3" style="padding: 2rem; padding-top: 0.75rem">
                                ...
                                <button class="btn btn-fill text-white">Atur Jadwal</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo">
                    ...
                    <div class="gap-3">
                        <button class="btn btn-default btn-no-fill">Log In</button>
                        <button class="btn btn-fill text-white">Atur Jadwals</button>
                    </div>
                </div>
            </nav>
            ...
            <div>
                <div class="mx-auto d-flex flex-lg-row flex-column hero">
                    ...
                    <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
                        <p class="text-caption">Join Us.</p>
                        <h1 class="title-text-big">
                            Cara terbaik untuk menentukan jadwal<br class="d-lg-block d-none" />
                            dengan dokter
                        </h1>
            ...
            <div class="border-color info-footer">
                ...
                <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
                    ...
                    <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                        <p style="margin: 0">Copyright © 2022 | Gilang | Farhan | Syafiq</p>
                    </nav>
                </div>
            </div>
        </div>
